<?php
/**
 * Bundled BFB template: Simple Booking Form.
 *
 * @package Booking Calendar
 * @file ../includes/page-form-builder/save-load/template-records/template-full_days_1step_2col_vertical_01.php
 */
...
$wpbc_simple_vertical_form_structure_json = trim(
	stripcslashes(
...
$wpbc_simple_vertical_form_settings_json = trim(
	stripcslashes(
...
$wpbc_simple_vertical_form_advanced_form = trim(
	stripcslashes(
...
$wpbc_simple_vertical_form_content_form = trim(
	stripcslashes(
...
return array(
	'template_key' => 'dates_form_with_vertical_layout',
	'seed_version' => '10.15',
	...
	'record'       => array(
		'form_slug'           => 'dates_form_with_vertical_layout',
		'status'              => 'template',
		'scope'               => 'global',
		'version'             => 1,
		...
		'engine'              => 'bfb',
		'engine_version'      => '1.0',
		'structure_json'      => $wpbc_simple_vertical_form_structure_json,
		'settings_json'       => $wpbc_simple_vertical_form_settings_json,
		'advanced_form'       => $wpbc_simple_vertical_form_advanced_form,
		'content_form'        => $wpbc_simple_vertical_form_content_form,
		'is_default'          => 0,
		'title'               => 'Full-Day / Form with Vertical Layout',
		'description'         => 'Simple one page booking form with fields in 2 columns. Full-days bookings.',
		'picture_url'         => 'dates_form_with_vertical_layout_01.png',
	),
);